    ...
    <aside className="w-[60px] min-w-[60px] bg-white border-r border-gray-100 flex flex-col items-center py-3 gap-1">
      ...
      <div className="mt-auto flex flex-col gap-1">
        {isAdmin ? (
          <NavLink
            ...
            className={({ isActive }) =>
              `w-11 h-11 rounded-xl flex items-center justify-center transition-all ${
                isActive ? "bg-rose-50 text-rose-700" : "text-gray-500 hover:bg-gray-50 hover:text-gray-700"
              }`
            }
            title="Admin Console"
          >
          ...
          <button
            className="w-11 h-11 rounded-xl flex items-center justify-center text-gray-300 cursor-not-allowed"
